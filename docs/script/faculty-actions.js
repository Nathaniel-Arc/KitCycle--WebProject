...
window.FacultyActions = {
    ...
    _getRequests: function() {
        if (!localStorage.getItem('kitcycle_faculty_requests')) {
            const defaults = [
                { id: 'req1', student: 'Maria Santos', studentId: '2024-12345', item: 'Engineering Microscope Set', duration: '3 days', purpose: 'Materials Science Lab Project', date: '3/5/2026', priority: 'HIGH', status: 'Pending', totalCost: 450, amountPaid: 0, paymentStatus: 'Unpaid', paymentMethod: 'Cash', proofRef: '' },
                { id: 'req2', student: 'Juan Reyes', studentId: '2024-12346', item: 'Scientific Calculator', duration: '1 week', purpose: 'Advanced Calculus Course', date: '3/4/2026', priority: 'MEDIUM', status: 'Pending', totalCost: 350, amountPaid: 0, paymentStatus: 'Unpaid', paymentMethod: 'GCash', proofRef: '' },
                ...
                { id: 'req4', student: 'Mark Tan', studentId: '2024-12348', item: 'Digital Multimeters', duration: '5 days', purpose: 'Circuit Analysis Lab', date: '3/6/2026', priority: 'LOW', status: 'Pending', totalCost: 400, amountPaid: 0, paymentStatus: 'Unpaid', paymentMethod: 'Cash', proofRef: '' },
    ...
    showReturnInspection: function(req) {
        ...
        overlay.innerHTML = `
            <div style="background:#fff;width:95%;max-width:420px;border-radius:20px;padding:25px;box-shadow:0 25px 50px rgba(0,0,0,0.25);animation:modalPop 0.3s cubic-bezier(0.175,0.885,0.32,1.275);max-height:90vh;overflow-y:auto;">
                <h3 style="margin:0 0 5px;color:#1e293b;text-align:center;"><i class="fas fa-search" style="color:#800000;"></i> Return Inspection</h3>
                ...
                <div style="display:flex;gap:10px;margin-top:20px;">
                    ...
                    <button id="confirmReturnBtn" style="flex:1;padding:10px;background:#800000;color:#fff;border:none;border-radius:8px;font-weight:700;cursor:pointer;">Confirm Return</button>
                </div>
            </div>
        `;
        document.body.appendChild(overlay);
